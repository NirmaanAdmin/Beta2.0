...
function calculate_invoice_total(annexure) {
  ...
  $.each(rows, function () {
    ...
    row.find("td.amount").html(format_money(_amount + item_taxes, true));
    total_tax += item_taxes;
  });

  total = subtotal + total_tax;

  $(".annexture_subtotal").html(format_money(subtotal));
  $(".annexture_tax").html(format_money(total_tax));
  $(".annexture_total").html(format_money(total));
