...
function calculate_unawarded_capex() {
  var total_budgeted_qty = 0,
  total_budgeted_rate = 0,
  total_budgeted_amount = 0,
  total_unawarded_qty = 0,
  total_unawarded_rate = 0,
  ...
  $.each(rows, function () {
    ...
    total_budgeted_qty += budgeted_qty;
    total_budgeted_rate += budgeted_rate;
    total_budgeted_amount += budgeted_amount;
    total_unawarded_qty += unawarded_qty;
    total_unawarded_rate += unawarded_rate;
    total_unawarded_amount += unawarded_amount;
    total_unallocated_cost += unallocated_cost;
  });
  $(".total_budgeted_qty").html(parseFloat(total_budgeted_qty).toFixed(2));
  $(".total_unawarded_qty").html(parseFloat(total_unawarded_qty).toFixed(2));
  $(".total_budgeted_rate").html(format_money(total_budgeted_rate));
  $(".total_budgeted_amount").html(format_money(total_budgeted_amount));
  $(".total_unawarded_rate").html(format_money(total_unawarded_rate));
