...
<?php } else if (
   !empty($file->pdf_attachment) &&
   in_array(strtolower(pathinfo($file->pdf_attachment, PATHINFO_EXTENSION)), ['dwg', 'xref'])
) { ?>
   ...
   <div style="position: relative; height: 100vh;">
      <iframe id="cadViewer"
         src="https://iframe.sharecad.org/cadframe/load?url=<?php echo base_url(DRAWING_MANAGEMENT_PATH . 'pdf_attachments/' . $file->id . '/' . rawurlencode($file->pdf_attachment)); ?>?v=<?php echo $rand; ?>"
...
<?php } else { ?>
   ...
   <p class="text-muted"><?php echo _l('no_preview_available_for_file'); ?></p>
