<script>
    ...
    initDataTable(table_manage_delivery, admin_url + 'warehouse/table_stock_reconciliation', [], [], InvoiceServerParams, [0, 'desc']);
    ...
    function init_goods_delivery(id) {
        "use strict";
        load_small_table_item_proposal(id, '#delivery_sm_view', 'delivery_id', 'warehouse/view_stock_reconciliation', '.delivery_sm');
    }
