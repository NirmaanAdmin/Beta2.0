...
<p class="p5"><b>Sub: Work Order for <span class="wo_order_name"></span> at ' . ($default_project == 8 ? 'Vedathma Properties in Alibaug, Maharashtra' : 'Basilius Guest House in Jamnagar, Gujarat.') . '</b></p>
<p class="p7">As subsequent discussions we had with you, We at <b>Basilius International LLP</b> (referred as Employer), accept your final offer and appoint <b>M/s. <span class="vendor_name"></span></b> (herein after called the Contractor) for<b> <span class="wo_order_name"></span> at ' . ($default_project == 8 ? 'Vedathma Properties in Alibaug, Maharashtra' : 'Basilius Guest House in Jamnagar, Gujarat.') . '</b> on the basis of detailed Bill of Quantities inclusive of remedying of any defects and safety measures of the above project for the item rate Contract Amount of <b><span class="order_summary_currency">INR</span> <span class="total_in_value"></span>/- (<span class="subtotal_in_words"></span> only) inclusive of GST, as tabulated below; </b></p>
<p class="p4"><b></b></p>
...
/**
 * Check if an ID is a Purchase Order ID or Work Order ID and return detailed information
 * 
