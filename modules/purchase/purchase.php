...
define('PURCHASE_REVISION', rand(100000, 999999));
...
function purchase_permissions()
{
    ...
    register_staff_capabilities('wklookahead', $capabilities_own, _l('wklookahead'));
