				...
				<table class="table dt-table" >
		            ...
		            <tbody>
		            	<?php foreach($pur_order as $p){ ?>
		            		...
		            		?>
		            		<tr>
		            			<td><a href="<?php echo site_url('purchase/vendors_portal/wo_order/'.$p['id']); ?>"><?php echo pur_html_entity_decode($p['wo_order_number']); ?></a>
		            			</td>
		            			...
		            			<td> 
		            				<a href="<?php echo site_url('purchase/vendors_portal/wo_order/'.$p['id']); ?>" class="btn btn-icon btn-info"><i class="fa fa-eye"></i></a>
