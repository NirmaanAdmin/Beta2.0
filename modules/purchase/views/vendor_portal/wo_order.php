        ...
        <div class="panel_s accounting-template estimate">
          <div class="panel-body">
            ...
            <div class="horizontal-scrollable-tabs preview-tabs-top">
              ...
              <div class="horizontal-tabs">
                <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                  <li role="presentation" class="<?php if ($this->input->get('tab') != 'discussion' && $this->input->get('tab') != 'attachment') {
                                                    echo 'active';
                                                  } ?>">
                  ...
                  <!-- <li role="presentation" class="<?php if ($this->input->get('tab') === 'quality') {
                                                    echo 'active';
                                                  } ?>">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane ptop10 <?php if ($this->input->get('tab') != 'discussion' && $this->input->get('tab') != 'attachment') {
                                                            echo 'active';
                                                          } ?>" id="general_infor">
                <div class="row">
                  ...
                  <?php if ($pur_order->order_status == 'confirmed') { ?>
                    <div class="col-md-4 col-md-offset-8">
                      <select name="delivery_status" onchange="update_delivery_status(this); return false;" id="delivery_status" class="selectpicker" data-live-search="true" data-width="100%">
                        <option value="0" <?php if ($pur_order->delivery_status == 0) {
                                            echo 'selected';
                                          } ?>><?php echo _l('undelivered'); ?></option>
                        <option value="1" <?php if ($pur_order->delivery_status == 1) {
                                            echo 'selected';
                                          } ?>><?php echo _l('completely_delivered'); ?></option>
                        <option value="2" <?php if ($pur_order->delivery_status == 2) {
                                            echo 'selected';
                                          } ?>><?php echo _l('pending_delivered'); ?></option>
                        <option value="3" <?php if ($pur_order->delivery_status == 3) {
                                            echo 'selected';
                                          } ?>><?php echo _l('partially_delivered'); ?></option>
                      </select>
                    </div>
                  <?php } ?>
                  <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered">
                      <tr>
                        <td width="30%"><?php echo _l('wo_order_number'); ?></td>
                        <td><?php echo pur_html_entity_decode($pur_order->wo_order_number) ?></td>
                      </tr>
                      <tr>
                        <td><?php echo _l('wo_order_name'); ?></td>
                        <td><?php echo pur_html_entity_decode($pur_order->wo_order_name) ?></td>
                      </tr>
                      <tr>
              ...
              <div role="tabpanel" class="tab-pane ptop10 <?php if ($this->input->get('tab') === 'quality') {
                                                            echo ' active';
                                                          } ?>" id="quality">
                <div class="row">
                  <div class="col-md-12">
                        ...
                        <tbody>
                          ...
                          foreach ($qor as $val) { ?>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php $url   = site_url('purchase/vendors_portal/view_quality_report/' . $val['formid']);?>
