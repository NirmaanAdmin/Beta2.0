              ...
              <div role="tabpanel" class="tab-pane ptop10 active" id="information">
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <?php
                      $vendor = (isset($payment_certificate) ? $payment_certificate->vendor : ''); 
                      echo render_select('vendor', $vendors, array('userid', 'company'), 'vendor', $vendor);
                      ?>
                    </div>
                    <div class="col-md-3">
                      <?php
                    ...
                    <div class="col-md-3">
                      <?php $order_date = (isset($payment_certificate) ? _d($payment_certificate->order_date) : _d(date('Y-m-d')));
                      echo render_date_input('order_date', 'order_date', $order_date); ?>
                    </div>
                    <div class="col-md-3">
                      <?php
                      echo render_select('project', $projects, array('id', 'name'), 'project');
                      ?>
                    </div>
                    <div class="col-md-3">
                  ...
                  <div class="row">
                    <div class="col-md-12 pc-table">
                      <div class="table-responsive">
                        <table class="table ot-payment-certificate-table items no-mtop">
                          <thead>
                            <tr>
                          ...
                          <tbody class="payment_certificate_body">
                            <tr>
                              <td>A1</td>
                              <td class="ot_name"></td>
                              <td class="ot_contract_amount"></td>
                              <td>
                                <?php
                                $ot_previous = (isset($payment_certificate) ? format_amount_cert($payment_certificate->po_previous) : '');
                                echo render_input('ot_previous', '', $ot_previous, 'number', ['oninput' => "calculate_payment_certificate()"]);
                                ?>
                              </td>
                              <td>
                                <?php
                                $ot_this_bill = (isset($payment_certificate) ? format_amount_cert($payment_certificate->po_this_bill) : '');
                                echo render_input('ot_this_bill', '', $ot_this_bill, 'number', ['oninput' => "calculate_payment_certificate()"]);
                                ?>
                              </td>
                              <td class="ot_comulative"></td>
                            </tr>
                            <tr class="table_head">
                              <td>A</td>
                              <td><?php echo _l('total_value_of_works_executed'); ?></td>
                              <td class="ot_contract_amount"></td>
                              <td class="total_ot_previous"></td>
                              <td class="total_ot_this_bill"></td>
                              <td class="ot_comulative"></td>
                            </tr>
                            <tr class="table_head">
                              <td>B</td>
...
<script>
  document.getElementById('export-csv').addEventListener('click', function(event) {
    ...
    const table = document.querySelector('.ot-payment-certificate-table');
