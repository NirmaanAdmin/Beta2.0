      ...
      <div class="panel-body">
         ...
         <div class="tab-content">
               ...
               <div id="estimate-preview">
                  <div class="row">
                     ...
                     <div class="col-md-6 col-sm-6">
                        ...
                        <address class="mbot5">
                           <?php echo format_order_based_organization_info($estimate->id, 'wo_order'); ?>
                        </address>
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="tab_activity">
               <div class="clearfix"></div>
               <table class="table table-wo-activity scroll-responsive">
                  <thead>
                           ...
                           <tr>
                              ...
                              <td>
                                 <?php if (has_permission('payment_certificate', '', 'edit') || is_admin()) { ?>
                                    <a href="<?php echo admin_url('purchase/wo_payment_certificate/' . $estimate->id . '/' . $pay['id']); ?>" target="_blank" class="btn btn-default btn-icon" data-toggle="tooltip" data-placement="top" title="<?php echo _l('view'); ?>"><i class="fa fa-eye "></i></a>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="checklist-feed">
                        <a href="<?php echo admin_url('purchase/add_checklist/' . $estimate->id.'/work_order'); ?>" target="_blank" class="btn btn-success pull-right"><i class="fa fa-plus"></i><?php echo ' ' . _l('Add'); ?></a>
...
<script>
   ...
   initDataTable('.table-debit-note', admin_url + 'purchase/debit_notes_table?order_rel_type=wo', false, false, fnDebitServerParams, [0, 'desc']);
   ...
   initDataTable('.table-credit-note', admin_url + 'credit_notes/table?order_rel_type=wo', false, false, fncreditServerParams, [0, 'desc']);

   var table_wo_activity = $('.table-wo-activity');
   if ($.fn.DataTable.isDataTable('.table-wo-activity')) {
      $('.table-wo-activity').DataTable().destroy();
   }
   var fnwoactivityServerParams;
   fnwoactivityServerParams = {
      "rel_id": '[name="_attachment_sale_id"]',
   }
   initDataTable('.table-wo-activity', admin_url + 'purchase/table_module_related_activity?module_name=wo', false, false, fnwoactivityServerParams, [1, 'desc']);
