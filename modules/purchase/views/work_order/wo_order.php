      ...
      <div class="col-md-12">
        <div class="panel_s accounting-template estimate">
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="tab-pane" id="billing_shipping_information">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <?php $billing_address = isset($wo_order) ? $wo_order->billing_address : get_option('billing_company_address', true);
                    if ($billing_address == '') {
                    ...
                    <?php $billing_zip = isset($wo_order) ? $wo_order->billing_zip : get_option('billing_company_zipcode', true);
                    if ($billing_zip == '') {
                    ...
                    <?php $billing_vat = isset($wo_order) ? $wo_order->billing_vat : get_option('billing_company_vat', true);
                    if ($billing_vat == '') {
                  ...
                  <div class="col-md-6">
                    <div class="row">
                      <div class="col-md-12">
                        <?php $billing_city = isset($wo_order) ? $wo_order->billing_city : get_option('billing_company_city', true);
                        if ($billing_city == '') {
                      ...
                      <div class="col-md-12">
                        <?php $billing_state = isset($wo_order) ? $wo_order->billing_state : get_option('billing_company_state', true);
                        if ($billing_state == '') {
                      ...
                      <div class="col-md-12">
                        <?php $billing_country_text = isset($wo_order) ? $wo_order->billing_country_text : get_option('billing_company_country_text', true);
                      ...
                      <div class="col-md-12">
                        ...
                        $selected = isset($wo_order) ? $wo_order->billing_country : $billing_company_country_code;
                        if ($selected == '') {
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php $shipping_vat = isset($wo_order) ? $wo_order->shipping_vat : get_option('pur_company_vat', true);
                    if ($shipping_vat == '') {
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12">
                <label for="shop_drawings_upload"><?php echo _l('shop_drawings_upload'); ?></label>
                <div class="shop_drawings">
                  <div class="shop_drawing">
                    <div class="col-md-5 form-group" style="padding-left: 0px;">
                      <div class="input-group">
                        <input type="file" extension="<?php echo str_replace(['.', ' '], '', get_option('ticket_attachments_file_extensions')); ?>" filesize="<?php echo file_upload_max_size(); ?>" class="form-control" name="shop_drawings[0]" accept="<?php echo get_ticket_form_accepted_mimes(); ?>">
                        <span class="input-group-btn">
                          <button class="btn btn-success add_more_shop_drawings p8" type="button"><i class="fa fa-plus"></i></button>
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <?php
              if (isset($shop_drawings) && count($shop_drawings) > 0) {
                foreach ($shop_drawings as $value) {
                  echo '<div class="col-md-3">';
                  $path = FCPATH . 'modules/warehouse/uploads/purchase_tracker/order_shop_drawings/work_orders/' . $value['rel_id'] . '/' . $value['file_name'];
                  $is_image = is_image($path);
                  if ($is_image) {
                    echo '<div class="preview_image">';
                  }
              ?>
                  <a href="<?php echo site_url('download/file/order_shop_drawings/' . $value['id']); ?>" class="display-block mbot5" <?php if ($is_image) { ?> data-lightbox="attachment-purchase-<?php echo $value['rel_id']; ?>" <?php } ?>>
                  ...
                  <?php
                  echo '<a href="' . admin_url('purchase/delete_order_shop_drawings_attachment/' . $value['id']) . '" class="text-danger _delete">' . _l('delete') . '</a>';
                  ?>
                    ...
                    <tr id="order_discount_percent">
                      <td>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <?php $discount_remarks = isset($wo_order) ? $wo_order->discount_remarks : '';
