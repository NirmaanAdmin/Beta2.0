                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 ">
                        <div class="form-group select-placeholder">
                          ...
                          if (isset($pur_order)) {
                            if ($pur_order->discount_type == 'before_tax' || $pur_order->discount_type == null) {
                              echo 'selected';
                            }
                          } else {
                            echo 'selected';
                          ...
                          <option value="after_tax" <?php if (isset($pur_order)) {
                            if ($pur_order->discount_type == 'after_tax') {
                              echo 'selected';
                            }
            ...
            <div class="row">
              ...
              if (isset($shop_drawings) && count($shop_drawings) > 0) {
                foreach ($shop_drawings as $value) {
                  ...
                  $path = FCPATH . 'modules/warehouse/uploads/purchase_tracker/order_shop_drawings/purchase_orders/' . $value['rel_id'] . '/' . $value['file_name'];
          ...
          <div class="row">
            <div class="col-md-12 mtop15">
              <div class="panel-body bottom-transaction">
                ...
                Acknowledgment of this Purchase Order, invoices, and commercial correspondence shall be sent by courier to the above address, attention Rupesh, with a scanned copy sent by mail to <strong>' . ($default_project == 8 ? 'abh.project@basilius.in' : 'bgj.project@basilius.in') . '</strong>.<br>
