                ...
                <div class="col-md-12">
                    <div class="panel_s">
                        <div class="panel-body">
                            ...
                            <p>
                                Matters not covered in the above as a whole shall be covered by the relevant Indian Standard Codes. If such codes on a particular subject have not been framed, the decision of the Project Manager shall be final.
                            </p>
                            <h3 id="section-4">
                                Purpose
                            </h3>
                            <p>
                                The purpose of this safety manual is to provide all contractors, a common set of basic safety requirements applicable to the construction site regardless its size. The information in this manual deals with a variety of hazards that have the potential to produce the highest level of risk. Appropriate safety measures are suggested to control the hazards and minimize the risk. It is each Contractor’s responsibility that they employs a well qualified (with relevant qualifications) and experienced Safety in Charge responsible for implementing and continuously communicating and driving the procedures throughout the labor force.
                            </p>
                            <h3 id="section-5">
                                Scope
                            </h3>
                            <p>
                                The scope of this Safety &amp; Health Procedures applies to all contractor and its subcontractor employees and to all construction and maintenance activities on the job site. This manual provides relevant information and procedures to assist the Contractor to ensure that his employees and sub-contractors work within a safety- conscious and safety-regulated environment. Compliance with the procedures set out in this manual shall not relieve the Contractor of any of his Statutory Duties or his responsibilities under the Contract.
                            </p>
                            <h3 id="section-6">
                                Selection of sub-contractor
                            </h3>
                            <p>
                                The main contractor shall select sub-contractors, using the same criteria of practical safety policy. Again, it must be ensured that the terms of contract include adequate provision for safe working practices &amp; for specified safety and health items. For all works carried out by sub contractors the responsibility of ensuring the required HSE lies with the main contractor only.
                            </p>
                            <h3 id="section-7">
                                Standards and References
                            </h3>
                            <p>
                                The Contractor and all Subcontractors are to comply with the Ascentis rules and procedures, the national legislation and codes and in particular the following standards:
                            </p>
                            <p>
                                IS: 3696 (Part I) -1987 Safety code for scaffolds and ladders: Part I
                            </p>
                            <p>
                                Scaffolds
                            </p>
                            <p>
                                IS: 3696 (Part II)-1991 Safety code for scaffolds and ladders: Part II
                            </p>
                            <p>
                                Ladders
                            </p>
                            ...
                            <p>
                                IS: 4014-(Part I) -1967 Code of Practice for Steel Tubular Scaffolding
                            </p>
                            <p>
                            ...
                            <p>
                                IS: 4130-1976 Safety code for demolition of building (first
                            </p>
                            <p>
                                revision)
                            </p>
                            ...
                            <p>
                                IS: 4912-1978 Safety requirements for floor and wall openings,
                            </p>
                            <p>
                            ...
                            <p>
                                IS: 5916-1970 Safety code for constructions involving use of hot
                            </p>
                            <p>
                            ...
                            <p>
                                IS: 8989-1978 Safety code for erection of concrete framed
                            </p>
                            <p>
                                structures
                            </p>
                            ...
                            <p>
                                IS: 13415-1992 Protective Barriers in and Around Buildings - Code
                            </p>
                            <p>
                                of Safety
                            </p>
                            <p>
                                IS: 13416-1992 Part 1 Recommendations for preventive measures
                            </p>
                            <p>
                                against hazards at workplaces Part 1 - Falling material hazards prevention
                            </p>
                            <p>
                                IS: 13416-1992 Part 2 Recommendations for preventive measures
                            </p>
                            <p>
                                against hazards at workplaces Part 2 - Fall prevention
                            </p>
                            <p>
                                IS: 13416-1994 Part 3 Recommendations for preventive measures
                            </p>
                            <p>
                                against hazards at workplaces Part 3 - Disposal of debris
                            </p>
                            <p>
                                IS: 13416-1994 Part 4 Recommendations for preventive measures
                            </p>
                            <p>
                                against hazards at workplaces Part 4 - Timber structure
                            </p>
                            <p>
                                IS: 13416-1994 Part 5 Recommendations for preventive measures
                            </p>
                            <p>
                                against hazards at workplaces Part 5 - Fire protection
                            </p>
                            <h2 id="section-8">
                                ELEMENTS OF CONSTRUCTION SAFETY
                            </h2>
