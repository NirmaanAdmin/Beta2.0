      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <div class="row">
              <div class="col-md-12">
                <h4 class="no-margin font-bold"><i class="fa fa-gavel" aria-hidden="true"></i> <?php echo _l($title); ?></h4>
                <hr />
              </div>
            </div>
            <!-- <div class="row">
              ...
              <div class="row">
                 <div class="col-md-12 mtop20">
                       ...
                       <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                             <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                   ...
                                   <span class="tw-truncate">Total Tenders</span>                 
                                </div>                      
                       ...
                       <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                             <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                   ...
                                   <span class="tw-truncate">Approved Tenders</span>                 
                                </div>                      
                       ...
                       <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                             <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                   ...
                                   <span class="tw-truncate">Draft Tenders</span>                 
                                </div>                      
                       ...
                       <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                             <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                   ...
                                   <span class="tw-truncate">Closed Tenders</span>                 
                                </div>                      
                    ...
                    <div class="row mtop20">
                      <div class="col-md-4">
                          <p class="mbot15 dashboard_stat_title">Doughnut Chart for Tender per Project</p>
                          <div style="width: 100%; height: 450px; display: flex; justify-content: left;">
                             <canvas id="doughnutChartProject"></canvas>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <p class="mbot15 dashboard_stat_title">Doughnut Chart for Tender per Budget Head</p>
                          <div style="width: 100%; height: 450px; display: flex; justify-content: left;">
                             <canvas id="doughnutChartBudgetHead"></canvas>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <p class="mbot15 dashboard_stat_title">Doughnut Chart for Tender per Department</p>
                          <div style="width: 100%; height: 450px; display: flex; justify-content: left;">
