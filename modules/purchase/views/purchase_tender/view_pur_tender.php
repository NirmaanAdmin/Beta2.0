                          ...
                          <thead class="bold">
                            <tr>
                              ...
                              foreach ($quotations as $quote) {
                                if (($quote['status'] ?? 1) == 2) {
                                  $has_approved_quotation = true;
                                  break;
                                }
                              }
                              foreach ($quotations as $quote) { ?>
                                <th colspan="2" class="text-center"><span class="bold text-danger"><?php echo format_pur_estimate_number($quote['id']) . ' - ' . get_vendor_company_name($quote['vendor']); ?></span>

                                  <div class="mt-1" style="text-align: end;margin-top: 10px;">
                                    <?php echo get_quotation_approval_button($quote['id'], $quote['status'] ?? 1, $quote, $has_approved_quotation);
                                    ?>
                                  </div>
                                </th>
                              <?php } ?>
