      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            ...
            <input type="hidden" id="pr_id" name="pr_id" value="<?= pur_html_entity_decode($pur_request->id); ?>" />
            ...
            <div class="row">
              ...
              <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane ptop10" id="tab_activity">
                   ...
                   <table class="table table-pr-activity scroll-responsive">
                      <thead>
...
<script>
  ...
  var table_pr_activity = $('.table-pr-activity');
  if ($.fn.DataTable.isDataTable('.table-pr-activity')) {
    $('.table-pr-activity').DataTable().destroy();
  }
  var fnpractivityServerParams;
  fnpractivityServerParams = {
    "rel_id": '[name="pr_id"]',
  }
  initDataTable('.table-pr-activity', admin_url + 'purchase/table_module_related_activity?module_name=pr', false, false, fnpractivityServerParams, [1, 'desc']);
</script>
