...
class Export_payment_certificate_pdf extends App_pdf
{
    protected $payment_certificate;

    public function __construct($payment_certificate)
    {
        $payment_certificate                = hooks()->apply_filters('request_html_pdf_data', $payment_certificate);
        $GLOBALS['Export_payment_certificate_pdf'] = $payment_certificate;
        parent::__construct();
    ...
    public function Header()
    {
        ...
        $this->SetXY(30, 190);
        $this->Cell(80, 12, _l('payment_certificate'), 0, 0, 'C');
    ...
    protected function file_path()
    {
        ...
        $actualPath = APP_MODULES_PATH . '/purchase/views/payment_certificate/export_payment_certificate_pdf.php';
