<script>
  ...
  $('.account-template-form-submiter').on('click', function() {
    ...
    $(document).on('change', '#related', function() {
      ...
      if(data.related) {
          $.post(admin_url+'changee/find_approval_setting',data).done(function(response){
    ...
    function edit_approval_setting(invoker,id){
        "use strict";
      appValidateForm($('#approval-setting-form'),{name:'required', related:'required', "approver[]": "required"});
      ...
      $.post(admin_url+'changee/find_project_members').done(function(response){
        response = JSON.parse(response);
      ...
      // $.post(admin_url + 'changee/get_html_approval_setting/'+ id).done(function(response) {
      //    response = JSON.parse(response);
    ...
    function new_approval_setting(){
      ...
      // $.post(admin_url + 'changee/get_html_approval_setting').done(function(response) {
      //    response = JSON.parse(response);
    ...
    function update_project_members()
    {
      ...
      if(project_id) {
          $('#approver').empty().selectpicker('refresh');
          $.post(admin_url+'changee/find_project_members',{'project_id':project_id}).done(function(response){
              response = JSON.parse(response);
              if(response.length > 0) {
                  $.each(response, function(idx, member) {
   ...
   function changee_order_setting(invoker){
    "use strict";
    ...
    $.post(admin_url + 'changee/changee_order_setting', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
...
function item_by_vendor(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/item_by_vendor', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function show_tax_column(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/show_tax_column', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function send_email_welcome_for_new_contact(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/send_email_welcome_for_new_contact', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function reset_changee_order_number_every_month(invoker){
  "use strict";
    var input_name = invoker.value;
    var input_name_status = $('input[id="'+invoker.value+'"]').is(":checked");
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/reset_changee_order_number_every_month', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function po_only_prefix_and_number(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/po_only_prefix_and_number', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function show_item_cf_on_pdf(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/show_item_cf_on_pdf', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
...
function allow_vendors_to_register(invoker){
  "use strict";
    ...
    var data = {};
        data.input_name = input_name;
        data.input_name_status = input_name_status;
    $.post(admin_url + 'changee/allow_vendors_to_register', data).done(function(response){
          response = JSON.parse(response); 
          if (response.success == true) {
              alert_float('success', response.message);
          }else{
