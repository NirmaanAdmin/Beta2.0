      ...
      <div class="panel-body">
         ...
         <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane ptop10" id="tab_activity">
               <div class="clearfix"></div>
               <table class="table table-co-activity scroll-responsive">
                  <thead>
...
<script>
   ...
   var table_co_activity = $('.table-co-activity');
   if ($.fn.DataTable.isDataTable('.table-co-activity')) {
      $('.table-co-activity').DataTable().destroy();
   }
   var fncoactivityServerParams;
   fncoactivityServerParams = {
      "rel_id": '[name="_attachment_sale_id"]',
   }
   initDataTable('.table-co-activity', admin_url + 'purchase/table_module_related_activity?module_name=co', false, false, fncoactivityServerParams, [1, 'desc']);
</script>