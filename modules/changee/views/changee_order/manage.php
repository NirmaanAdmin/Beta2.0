                           ...
                           <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                                 <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                    <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                       ...
                                       <span class="tw-truncate">Total CO Value</span>                 
                                    </div>                      
                                    <span class="tw-font-semibold tw-text-neutral-600 tw-shrink-0 total_co_value"></span>  
                                 </div>                    
                           ...
                           <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                                 <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                    <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                       ...
                                       <span class="tw-truncate">Approved CO Value</span>                 
                                    </div>                      
                                    <span class="tw-font-semibold tw-text-neutral-600 tw-shrink-0 approved_co_value"></span>  
                                 </div>                    
                                 <div class="progress tw-mb-0 tw-mt-4 progress-bar-mini">                      
                           ...
                           <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6 col-lg-3 tw-mb-2 sm:tw-mb-0">    <div class="top_stats_wrapper">                                  
                                 <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                    <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center tw-truncate">                          
                                       ...
                                       <span class="tw-truncate">Draft CO Value</span>                 
                                    </div>                      
                                    <span class="tw-font-semibold tw-text-neutral-600 tw-shrink-0 draft_co_value"></span>  
                                 </div>                    
                                 <div class="progress tw-mb-0 tw-mt-4 progress-bar-mini">                      
