...
class Forms_model extends App_Model
{
    ...
    public function add($data, $admin = null, $pipe_attachments = false)
    {
        ...
        if (isset($data['form_type'])) {
            ...
            } elseif ($data['form_type'] == "hw") {
                $hw_form = [];
                $hw_form['fn'] = $data['fn'];
                $hw_form['rev_no'] = $data['rev_no'];
                $hw_form['date'] = $data['date'];
                $hw_form['location'] = $data['location'];
                $hw_form['sub_contractor'] = $data['sub_contractor'];
                $hw_form['datetime'] = $data['datetime'];
                $hw_form['shift'] = $data['shift'];
                unset($data['fn']);
                unset($data['rev_no']);
                unset($data['date']);
                unset($data['location']);
            ...
            } elseif ($data['form_type'] == "bljcb") {
                $bljcb_form = [];
                $bljcb_form['date'] = $data['date'];
                $bljcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $bljcb_form['checklist_no'] = $data['checklist_no'];
                $bljcb_form['remarks'] = $data['remarks'];
                $bljcb_form['fit_status'] = $data['fit_status'];
                $bljcb_form['inspected_by'] = $data['inspected_by'];
                $bljcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
            ...
            } elseif ($data['form_type'] == "bbmjcb") {
                $bbmjcb_form = [];
                $bbmjcb_form['date'] = $data['date'];
                $bbmjcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $bbmjcb_form['checklist_no'] = $data['checklist_no'];
                $bbmjcb_form['remarks'] = $data['remarks'];
                $bbmjcb_form['fit_status'] = $data['fit_status'];
                $bbmjcb_form['inspected_by'] = $data['inspected_by'];
                $bbmjcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
                unset($data['name_of_contractor']);
                unset($data['checklist_no']);
                unset($data['remarks']);
            ...
            } elseif ($data['form_type'] == "bcmjcb") {
                $bcmjcb_form = [];
                $bcmjcb_form['date'] = $data['date'];
                $bcmjcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $bcmjcb_form['checklist_no'] = $data['checklist_no'];
                $bcmjcb_form['remarks'] = $data['remarks'];
                $bcmjcb_form['fit_status'] = $data['fit_status'];
                $bcmjcb_form['inspected_by'] = $data['inspected_by'];
                $bcmjcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
                unset($data['name_of_contractor']);
                unset($data['checklist_no']);
                unset($data['remarks']);
            ...
            } elseif ($data['form_type'] == "ecjcb") {
                $ecjcb_form = [];
                $ecjcb_form['date'] = $data['date'];
                $ecjcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $ecjcb_form['checklist_no'] = $data['checklist_no'];
                $ecjcb_form['remarks'] = $data['remarks'];
                $ecjcb_form['fit_status'] = $data['fit_status'];
                $ecjcb_form['inspected_by'] = $data['inspected_by'];
                $ecjcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
                unset($data['name_of_contractor']);
                unset($data['checklist_no']);
                unset($data['remarks']);
            ...
            } elseif ($data['form_type'] == "cmjcb") {
                $cmjcb_form = [];
                $cmjcb_form['date'] = $data['date'];
                $cmjcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $cmjcb_form['checklist_no'] = $data['checklist_no'];
                $cmjcb_form['remarks'] = $data['remarks'];
                $cmjcb_form['fit_status'] = $data['fit_status'];
                $cmjcb_form['inspected_by'] = $data['inspected_by'];
                $cmjcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
                unset($data['name_of_contractor']);
                unset($data['checklist_no']);
                unset($data['remarks']);
            ...
            } elseif ($data['form_type'] == "cpjcb") {
                $cpjcb_form = [];
                $cpjcb_form['date'] = $data['date'];
                $cpjcb_form['name_of_contractor'] = $data['name_of_contractor'];
                $cpjcb_form['checklist_no'] = $data['checklist_no'];
                $cpjcb_form['remarks'] = $data['remarks'];
                $cpjcb_form['fit_status'] = $data['fit_status'];
                $cpjcb_form['inspected_by'] = $data['inspected_by'];
                $cpjcb_form['reviewed_by'] = $data['reviewed_by'];
                unset($data['date']);
                unset($data['name_of_contractor']);
                unset($data['checklist_no']);
                unset($data['remarks']);
        ...
        if ($formid) {
            if ($data['form_type'] == "dpr") {
                ...
                if (isset($hw_form)) {
                    if (!empty($hw_form)) {
                        $hw_form['form_id'] = $formid;
                        $this->db->insert(db_prefix() . $data['form_type'] . '_form', $hw_form);
                    }
                }
                if (isset($new_order)) {
                    if (!empty($new_order)) {
                ...
                if (isset($bljcb_form)) {
                    if (!empty($bljcb_form)) {
                        $bljcb_form['form_id'] = $formid;
                        $this->db->insert(db_prefix() . $data['form_type'] . '_form', $bljcb_form);
                    }
                }
                if (isset($new_order)) {
                    if (!empty($new_order)) {
                ...
                if (isset($bbmjcb_form)) {
                    if (!empty($bbmjcb_form)) {
                        $bbmjcb_form['form_id'] = $formid;
                        $this->db->insert(db_prefix() . $data['form_type'] . '_form', $bbmjcb_form);
                    }
                }
                if (isset($new_order)) {
                    if (!empty($new_order)) {
                ...
                if (isset($ecjcb_form)) {
                    if (!empty($ecjcb_form)) {
                        $ecjcb_form['form_id'] = $formid;
                        $this->db->insert(db_prefix() . $data['form_type'] . '_form', $ecjcb_form);
                    }
                }
                if (isset($new_order)) {
                    if (!empty($new_order)) {
                ...
                if (isset($cpjcb_form)) {
                    if (!empty($cpjcb_form)) {
                        $cpjcb_form['form_id'] = $formid;
                        $this->db->insert(db_prefix() . $data['form_type'] . '_form', $cpjcb_form);
                    }
                }
                if (isset($new_order)) {
                    if (!empty($new_order)) {
    ...
    public function update_single_form_settings($data)
    {
        ...
        } elseif ($formBeforeUpdate->form_type == "hw") {
            $hw_form = [];
            $hw_form['fn'] = $data['fn'];
            $hw_form['rev_no'] = $data['rev_no'];
            $hw_form['date'] = $data['date'];
        ...
        } elseif ($formBeforeUpdate->form_type == "bljcb") {
        ...
        } elseif ($formBeforeUpdate->form_type == "bbmjcb") {
        ...
        } elseif ($formBeforeUpdate->form_type == "bcmjcb") {
        ...
        } elseif ($formBeforeUpdate->form_type == "ecjcb") {
        ...
        } elseif ($formBeforeUpdate->form_type == "cmjcb") {
        ...
        } elseif ($formBeforeUpdate->form_type == "cpjcb") {
        ...
        if ($formBeforeUpdate->form_type == "dpr") {
            ...
            if (isset($hw_form)) {
                if (!empty($hw_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $hw_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
            ...
            if (isset($bljcb_form)) {
                if (!empty($bljcb_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $bljcb_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
            ...
            if (isset($bbmjcb_form)) {
                if (!empty($bbmjcb_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $bbmjcb_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
            ...
            if (isset($bcmjcb_form)) {
                if (!empty($bcmjcb_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $bcmjcb_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
            ...
            if (isset($ecjcb_form)) {
                if (!empty($ecjcb_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $ecjcb_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
            ...
            if (isset($cpjcb_form)) {
                if (!empty($cpjcb_form)) {
                    $this->db->where('form_id', $data['formid']);
                    $this->db->update(db_prefix() . $formBeforeUpdate->form_type . '_form', $cpjcb_form);
                    if ($this->db->affected_rows() > 0) {
                        $affectedRows++;
                    }
                }
    ...
    public function get_hw_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'hw_form')->row();
    }
    public function get_hw_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
    ...
    public function get_bljcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'bljcb_form')->row();
    }

    public function get_bljcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'bljcb_form_detail')->result_array();
    }
    public function get_bbmjcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'bbmjcb_form')->row();
    }

    public function get_bbmjcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'bbmjcb_form_detail')->result_array();
    }
    public function get_bcmjcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'bcmjcb_form')->row();
    }

    public function get_bcmjcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
    ...
    public function get_ecjcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'ecjcb_form')->row();
    }

    public function get_ecjcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'ecjcb_form_detail')->result_array();
    }

    public function get_cmjcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'cmjcb_form')->row();
    }

    public function get_cmjcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
    ...
    public function get_cpjcb_form($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'cpjcb_form')->row();
    }

    public function get_cpjcb_form_detail($form_id)
    {
        $this->db->where('form_id', $form_id);
        return $this->db->get(db_prefix() . 'cpjcb_form_detail')->result_array();
    }
