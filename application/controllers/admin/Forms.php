...
class Forms extends AdminController
{
    ...
    public function find_form_design($form_type, $form_id = 0)
    {
        ...
        if ($form_type == "dpr") {
            ...
            $formConfigs = [
                ...
                'dujcb'   => ['has_attachments' => false],
                'ecjcb'   => ['has_attachments' => false],
                'cmjcb'    => ['has_attachments' => false],
                'tmjcb'    => ['has_attachments' => false],
                'cpjcb'    => ['has_attachments' => false],
                'bpjcb'    => ['has_attachments' => false],
                'evjcb'    => ['has_attachments' => false],
                'bcmjcb'   => ['has_attachments' => false],
                'bbmjcb'   => ['has_attachments' => false],
                'bjcb'     => ['has_attachments' => false],
                'dmjcb'    => ['has_attachments' => false],
                'hyjcb'    => ['has_attachments' => false],
                'mcjcb'    => ['has_attachments' => false],
                'tcjcb'    => ['has_attachments' => false],
                'dgjcb'    => ['has_attachments' => false],
                'sdpjcb'   => ['has_attachments' => false],
                'scsjcb'   => ['has_attachments' => false],
                'pgjcb'    => ['has_attachments' => false],
                'wmjcb'    => ['has_attachments' => false],
                'epmjcb'    => ['has_attachments' => false],
                'wimjcb'    => ['has_attachments' => false],
                'cpbjcb'    => ['has_attachments' => false],
                'lttjcb'    => ['has_attachments' => false],
                'acjcb'     => ['has_attachments' => false],
                'gsbsjcb'   => ['has_attachments' => false],
                'fejcb'     => ['has_attachments' => false],
                'bcmajcb'   => ['has_attachments' => false],
                'pgrjcb'    => ['has_attachments' => false],
                'csjcb'     => ['has_attachments' => false],
                'bptjcb'    => ['has_attachments' => false],
                ...
                'bujcb'     => ['has_attachments' => false],
                'dtjcb'     => ['has_attachments' => false],
                'wtjcb'     => ['has_attachments' => false],
                'bijcb'     => ['has_attachments' => false],
            ];
    ...
    public function pdf_ecjcb($id)
    {
        $this->generate_form_pdf($id, 'ecjcb');
    }

    public function pdf_cmjcb($id)
    {
    ...
    public function pdf_cpjcb($id)
    {
        $this->generate_form_pdf($id, 'cpjcb');
    }
