...
class Form_pdf_vtf extends App_pdf
{
    protected $form;
    protected $subject;
    protected $vtf_data;
    protected $vtf_details;
    protected $form_data;

    public function __construct($form)
    {
        // store the form object globally if some hooks need it
        $GLOBALS['Form_pdf_vtf'] = $form;
        ...
        $this->vtf_data = $this->ci->forms_model->get_vtf_form($this->form->formid);
        $this->vtf_details = $this->ci->forms_model->get_vtf_form_detail($this->form->formid);
    ...
    public function prepare()
    {
        $this->set_view_vars([
            ...
            'form'    => $this->form,
            'vtf_data' => $this->vtf_data,
            'vtf_details' => $this->vtf_details,
