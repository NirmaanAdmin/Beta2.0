...
class Form_pdf_wpf extends App_pdf
{
    protected $form;
    protected $subject;
    protected $wpf_data;
    protected $wpf_details;
    protected $form_data;

    public function __construct($form)
    {
        // store the form object globally if some hooks need it
        $GLOBALS['Form_pdf_wpf'] = $form;
        ...
        $this->wpf_data = $this->ci->forms_model->get_wpf_form($this->form->formid);
        $this->wpf_details = $this->ci->forms_model->get_wpf_form_detail($this->form->formid);
    ...
    public function prepare()
    {
        $this->set_view_vars([
            ...
            'form'    => $this->form,
            'wpf_data' => $this->wpf_data,
            'wpf_details' => $this->wpf_details,
