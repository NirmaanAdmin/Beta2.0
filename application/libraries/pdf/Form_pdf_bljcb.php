...
class Form_pdf_bljcb extends App_pdf
{
    protected $form;
    protected $subject;
    protected $bljcb_data;
    protected $bljcb_details;
    protected $form_data;
    ...
    public function __construct($form)
    {
        ...
        $this->bljcb_data = $this->ci->forms_model->get_bljcb_form($this->form->formid);
        $this->bljcb_details = $this->ci->forms_model->get_bljcb_form_detail($this->form->formid);
        $this->form_data = $this->ci->forms_model->get_form_by_id($this->form->formid);
        $this->form_itmes = $this->ci->forms_model->get_form_items('bljcb');
    ...
    public function prepare()
    {
        $this->set_view_vars([
            ...
            'form'    => $this->form,
            'bljcb_data' => $this->bljcb_data,
            'bljcb_details' => $this->bljcb_details,
