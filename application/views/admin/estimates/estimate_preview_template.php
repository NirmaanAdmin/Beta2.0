    ...
    [
            ...
            <?php } ?>
                ...
                <div role="tabpanel" class="tab-pane ptop10" id="tab_activity">
                   <div class="clearfix"></div>
                   <table class="table table-bud-activity scroll-responsive">
                      <thead>
...
var table_bud_activity = $('.table-bud-activity');
if ($.fn.DataTable.isDataTable('.table-bud-activity')) {
  $('.table-bud-activity').DataTable().destroy();
}
var fnbudactivityServerParams;
fnbudactivityServerParams = {
  "rel_id": '[name="_attachment_sale_id"]',
}
initDataTable('.table-bud-activity', admin_url + 'purchase/table_module_related_activity?module_name=bud', false, false, fnbudactivityServerParams, [1, 'desc']);
