...
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table dpr-items-table items table-main-dpr-edit has-calculations no-mtop">
            ...
            <thead>
                <tr>
                    <th colspan="4" class="daily_report_title">WORK AT HEIGHT</th>
                </tr>
                ...
                <tr>
                    <th colspan="2" class="daily_report_head">
                        ...
                        <input type="text" class="form-control" name="fn"
                            value="<?= isset($wah_form->fn) ? $wah_form->fn : '' ?>" style="width: 40%;">
                    </th>

                    <th colspan="2" class="daily_report_head">
                        Rev. No:
                        <input type="text" class="form-control" name="rev_no"
                            value="<?= isset($wah_form->rev_no) ? $wah_form->rev_no : '' ?>">
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th colspan="2" class="daily_report_head">
                        Work Location:
                        <?php echo render_input('location', '', isset($wah_form->location) ? $wah_form->location : ''); ?>
                    </th>
                </tr>
                ...
                <tr>
                    <th colspan="2" class="daily_report_head">
                        ...
                        <input type="text" class="form-control" name="sub_contractor"
                            value="<?= isset($wah_form->sub_contractor) ? $wah_form->sub_contractor : '' ?>" style="width: 40%;">
                    </th>

                    <th class="daily_report_head">
                        Date & Time:
                        <?php echo render_input('datetime', '', isset($wah_form->datetime) ? $wah_form->datetime : '', 'datetime-local'); ?>
                    </th>
                    ...
                    <th class="daily_report_head">
                        ...
                        <select name="shift" class="form-control">
                            <option value=""></option>
                            <option value="1" <?= (isset($wah_form->shift) && $wah_form->shift == 1) ? 'selected' : '' ?>>Day</option>
                            <option value="2" <?= (isset($wah_form->shift) && $wah_form->shift == 2) ? 'selected' : '' ?>>Night</option>
                        </select>
                    </th>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo render_select(
                                ...
                                ['id', 'name'],
                                '',
                                isset($wah_form_detail) ? $wah_form_detail[$key]['description'] : ''
                            ); ?>
                        </td>

                        <td>
                            <span class="daily_report_label" style="display: ruby;">
                                <?php echo render_textarea('items[' . $sr . '][remarks]', '', isset($wah_form_detail) ? $wah_form_detail[$key]['remarks'] : '',  ['style' => 'width:150px;height:35px']); ?>
                            </span>
                        </td>
                    </tr>
