...
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table dpr-items-table items table-main-dpr-edit has-calculations no-mtop">
            ...
            <thead>
                <tr>
                    <th colspan="5" class="daily_report_title">Four Wheeler</th>
                </tr>
                <tr>
                ...
                <tr>
                    <th colspan="5" class="daily_report_head">
                        <span class="daily_report_label">Equipment Name & Number: 40 - Four Wheeler  &</span>
                    </th>
                </tr>
                <tr>
                    <th colspan="5" class="daily_report_head">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="<?php echo base_url('assets/images/fwjcb.jpg') ?>" alt="">
        </div>
    </div>
