        ...
        <table class="table dpr-items-table items table-main-dpr-edit has-calculations no-mtop">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th colspan="2" class="daily_report_head">
                        <span class="daily_report_label" style="display: ruby;">Contractor Name :</span><span class="daily_report_label" style="display: ruby;"> <?php echo render_select('name_of_contractor', get_vendor_list_for_forms(), array('userid', 'company'), '', isset($ecjcb_form->name_of_contractor) ? $ecjcb_form->name_of_contractor : ''); ?></span>
                    </th>
                </tr>
                <tr>
                    <th colspan="3" class="daily_report_head">
                        <span class="daily_report_label" style="display: ruby;">Checklist No.: <?php echo render_input('checklist_no', '', isset($ecjcb_form->checklist_no) ? $ecjcb_form->checklist_no : '', 'text', ['style' => 'width:150px;']); ?></span>
                    </th>
                    <th colspan="2" class="daily_report_head">

                        <span class="daily_report_label">Date: </span><input type="datetime-local" class="form-control" name="date" value="<?= isset($ecjcb_form->date) ? date('Y-m-d\TH:i', strtotime($ecjcb_form->date)) : '' ?>">
            ...
            <tbody>
                ...
                foreach ($form_items as $key => $value):
                    $id = isset($ecjcb_form_detail) ? $ecjcb_form_detail[$key]['id'] : ''; ?>
                    <tr class="main">
                        ...
                        <td>
                            <span class="daily_report_label" style="display: ruby;">
                                <?php echo render_select('items[' . $sr . '][status]', get_item_status_listing(), array('id', 'name'), '', isset($ecjcb_form_detail) ? $ecjcb_form_detail[$key]['status'] : ''); ?>
                            </span>
                        </td>
                        <td>
                            <span class="daily_report_label" style="display: ruby;">
                                <?php echo render_input('items[' . $sr . '][remarks]', '', isset($ecjcb_form_detail) ? $ecjcb_form_detail[$key]['remarks'] : '', 'text', ['style' => 'width:150px;']); ?>
                            </span>
                        </td>
                    </tr>
                <?php $sr++;
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <?php echo render_textarea('remarks', 'Remarks', isset($ecjcb_form) ? $ecjcb_form->remarks : '',  ['style' => 'height:267px;resize: none;']); ?>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <table class="table items table-main-dpr-edit no-mtop" style="margin-top:20px;">
        ...
        <tr>
            <td colspan="2" class="daily_report_head">
                <span class="daily_report_label" style="display: ruby;">Inspected By Name: <?php echo render_select('inspected_by', get_staff_list(), array('staffid', 'name'), '', isset($ecjcb_form->inspected_by) ? $ecjcb_form->inspected_by : ''); ?></span>
            </td>
            <td class="daily_report_head">
                <span class="daily_report_label" style="display: ruby;">Reviewed By Name: <?php echo render_select('reviewed_by', get_staff_list(), array('staffid', 'name'), '', isset($ecjcb_form->reviewed_by) ? $ecjcb_form->reviewed_by : ''); ?></span>
            </td>
        </tr>
