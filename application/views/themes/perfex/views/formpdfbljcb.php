...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($bljcb_data->name_of_contractor) ? get_vendor_name_by_id($bljcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($bljcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($bljcb_data->date) ? date('d M, Y H:i A', strtotime($bljcb_data->date)) : '') . '</td>
</tr>
...
<tr>
    ...
    <td width="50%">1-<b>BACKHOE LOADER (JCB)</b> &</td>
</tr>
<tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/bhjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($bljcb_data->fit_status) ? $bljcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($bljcb_data->inspected_by) ? get_staff_namebyId($bljcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($bljcb_data->reviewed_by) ? get_staff_namebyId($bljcb_data->reviewed_by) : '') . '</td>
</tr>
