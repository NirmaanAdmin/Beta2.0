...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($cpjcb_data->name_of_contractor) ? get_vendor_name_by_id($cpjcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($cpjcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($cpjcb_data->date) ? date('d M, Y H:i A', strtotime($cpjcb_data->date)) : '') . '</td>
</tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/cpjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($cpjcb_data->fit_status) ? $cpjcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($cpjcb_data->inspected_by) ? get_staff_namebyId($cpjcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($cpjcb_data->reviewed_by) ? get_staff_namebyId($cpjcb_data->reviewed_by) : '') . '</td>
</tr>
