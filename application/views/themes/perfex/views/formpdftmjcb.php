...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($tmjcb_data->name_of_contractor) ? get_vendor_name_by_id($tmjcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($tmjcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($tmjcb_data->date) ? date('d M, Y H:i A', strtotime($tmjcb_data->date)) : '') . '</td>
</tr>
...
<tr>
    ...
    <td width="50%">6-<b>TRANSIT MIXER</b> &</td>
</tr>
<tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/tmjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($tmjcb_data->fit_status) ? $tmjcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($tmjcb_data->inspected_by) ? get_staff_namebyId($tmjcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($tmjcb_data->reviewed_by) ? get_staff_namebyId($tmjcb_data->reviewed_by) : '') . '</td>
</tr>
