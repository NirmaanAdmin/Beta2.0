...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($exjcb_data->name_of_contractor) ? get_vendor_name_by_id($exjcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($exjcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($exjcb_data->date) ? date('d M, Y H:i A', strtotime($exjcb_data->date)) : '') . '</td>
</tr>
...
<tr>
    ...
    <td width="50%">2-<b>EXCAVATOR</b> &</td>
</tr>
<tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/exjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($exjcb_data->fit_status) ? $exjcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($exjcb_data->inspected_by) ? get_staff_namebyId($exjcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($exjcb_data->reviewed_by) ? get_staff_namebyId($exjcb_data->reviewed_by) : '') . '</td>
</tr>
