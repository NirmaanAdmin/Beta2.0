...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($cmjcb_data->name_of_contractor) ? get_vendor_name_by_id($cmjcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($cmjcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($cmjcb_data->date) ? date('d M, Y H:i A', strtotime($cmjcb_data->date)) : '') . '</td>
</tr>
...
<tr>
    ...
    <td width="50%">5-<b>CONCRETE MIXER</b> &</td>
</tr>
<tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/cmjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($cmjcb_data->fit_status) ? $cmjcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($cmjcb_data->inspected_by) ? get_staff_namebyId($cmjcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($cmjcb_data->reviewed_by) ? get_staff_namebyId($cmjcb_data->reviewed_by) : '') . '</td>
</tr>
