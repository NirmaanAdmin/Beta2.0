...
<tr>
    ...
    <td width="50%"><b>Contracto Name:</b> ' . (isset($ecjcb_data->name_of_contractor) ? get_vendor_name_by_id($ecjcb_data->name_of_contractor) : '') . '</td>
</tr>
<tr>
    <td><b>Checklist No.:</b> ' . ($ecjcb_data->checklist_no ?? '') . '</td>
    <td><b>Date:</b> ' . (!empty($ecjcb_data->date) ? date('d M, Y H:i A', strtotime($ecjcb_data->date)) : '') . '</td>
</tr>
...
<tr>
    ...
    <td width="50%">4-<b>EARTH COMPACTOR (ROLLER)</b> &</td>
</tr>
<tr>
...
$formhtml .= '<div class="col-md-6" style="text-align:center;">
    <img src="' . base_url("assets/images/ecjcb.jpg") . '" alt="">
</div>';
$checked_new = '<img src="' . base_url('assets/images/checked.png') . '" width="15">';
$fit_status = isset($ecjcb_data->fit_status) ? $ecjcb_data->fit_status : 0;
...
<tr>
    <td><b>Name:</b> ' . (isset($ecjcb_data->inspected_by) ? get_staff_namebyId($ecjcb_data->inspected_by) : '') . '</td>
    <td><b>Name:</b> ' . (isset($ecjcb_data->reviewed_by) ? get_staff_namebyId($ecjcb_data->reviewed_by) : '') . '</td>
</tr>
